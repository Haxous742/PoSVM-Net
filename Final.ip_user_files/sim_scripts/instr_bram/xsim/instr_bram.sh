...
#
# Script generated by Vivado on Thu May 21 17:02:12 IST 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : instr_bram.sh
...
#
# Usage        : instr_bram.sh
#                instr_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instr_bram.sh [-reset_run]
#                instr_bram.sh [-reset_log]
#                instr_bram.sh [-help]
#
...
# script info
echo -e "instr_bram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instr_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot instr_bram xil_defaultlib.instr_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim instr_bram -key {Behavioral:sim_1:Functional:instr_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb instr_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./instr_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: instr_bram.sh [-help]\n\
Usage: instr_bram.sh [-step]\n\
Usage: instr_bram.sh [-lib_map_path]\n\
Usage: instr_bram.sh [-reset_run]\n\
Usage: instr_bram.sh [-reset_log]\n\
Usage: instr_bram.sh [-keep_index]\n\
Usage: instr_bram.sh [-noclean_files]\n\n\
