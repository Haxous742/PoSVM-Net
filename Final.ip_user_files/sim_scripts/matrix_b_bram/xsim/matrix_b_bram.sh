...
elaborate()
{
  xelab --incr --debug typical --relax --mt off  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot matrix_b_bram xil_defaultlib.matrix_b_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim matrix_b_bram -key {Behavioral:sim_1:Functional:matrix_b_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb matrix_b_bram.wdb xsim.dir libdpi.so)
