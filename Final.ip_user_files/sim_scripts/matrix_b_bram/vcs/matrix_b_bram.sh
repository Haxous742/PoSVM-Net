...
#
# Script generated by Vivado on Tue Jun 09 13:04:07 IST 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : matrix_b_bram.sh
...
#
# Usage        : matrix_b_bram.sh
#                matrix_b_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                matrix_b_bram.sh [-reset_run]
#                matrix_b_bram.sh [-reset_log]
#                matrix_b_bram.sh [-help]
#
...
#                script (type 'matrix_b_bram.sh -help' for more information).
#
...
# script info
echo -e "matrix_b_bram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./matrix_b_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.matrix_b_bram xil_defaultlib.glbl -o matrix_b_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./matrix_b_bram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ihs06/cnn_svm_hybrid/Vivado/Final/Final.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key matrix_b_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc matrix_b_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./matrix_b_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: matrix_b_bram.sh [-help]\n\
Usage: matrix_b_bram.sh [-step]\n\
Usage: matrix_b_bram.sh [-lib_map_path]\n\
Usage: matrix_b_bram.sh [-reset_run]\n\
Usage: matrix_b_bram.sh [-reset_log]\n\
Usage: matrix_b_bram.sh [-keep_index]\n\
Usage: matrix_b_bram.sh [-noclean_files]\n\n\
