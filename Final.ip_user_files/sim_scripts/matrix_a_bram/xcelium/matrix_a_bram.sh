...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.matrix_a_bram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.matrix_a_bram -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ihs06/cnn_svm_hybrid/Vivado/Final/Final.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log matrix_a_bram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
