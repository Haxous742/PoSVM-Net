...
(
  ...
  //HDC predicted class vector
  
  input logic [3:0]            hdc_predicted_class
);
...
`endif
  ...
  // HDC CSR address
  localparam int unsigned CSR_predicted_class = 12'h7c4;
  ...
  begin
    ...
    case (csr_addr_i)
      ...
      12'h7c4: csr_rdata_int = {27'b0, hdc_predicted_class};   ///todo
    endcase
  end
